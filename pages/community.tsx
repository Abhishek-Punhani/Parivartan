                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <p className="text-gray-600 mb-6">
                      Making a difference is easier than you think! Organize
                      your own river cleanup event and we'll help you every step
                      of the way.
                    </p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Choose a location, date, and time that works for
                            your community.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Invite friends, family, and use our platform to
                            gather participants.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Lead the cleanup and track your impact with our
                            reporting tools.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-6 border border-green-100">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      river conservation. Our team will provide guidance and
                      resources to help ensure your event is a success.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                      ...
                      <p className="text-gray-600">
                        Recognizing our most active community members making a
                        difference in river conservation.
                      </p>
                    </div>
                    ...
                    <div className="divide-y divide-gray-200">
                      {topContributors.map((user, index) => (
                        ...
                        >
                          <div className="font-semibold text-lg text-gray-500 w-8 text-center">
                            {index + 1}
                          </div>
