            ...
            <TabsContent value="chatbot" className="space-y-8">
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-6 border-b border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Our AI assistant can answer your questions about river
                    pollution, cleanup methods, and more.
                  </p>
                </div>
                ...
                <div className="h-[400px] p-6 overflow-y-auto bg-gray-50">
                  <div className="space-y-4">
                    <div className="flex justify-start">
                      <div className="bg-white rounded-lg rounded-tl-none p-4 max-w-[80%] shadow-sm">
                        <p className="text-gray-800">
                          Hello! I'm RiverBot, your assistant for river
                          pollution information. How can I help you today?
                        </p>
                      </div>
                    </div>

                    <div className="flex justify-end">
                      <div className="bg-blue-500 text-white rounded-lg rounded-tr-none p-4 max-w-[80%] shadow-sm">
                        <p>
                    ...
                    <div className="flex justify-start">
                      <div className="bg-white rounded-lg rounded-tl-none p-4 max-w-[80%] shadow-sm">
                        <p className="text-gray-800">
                          The main causes of river pollution in India include:
                        </p>
                        <ol className="list-decimal pl-5 mt-2 space-y-1 text-gray-800">
                          <li>Untreated sewage discharge from urban areas</li>
                          <li>
                            Industrial effluents containing heavy metals and
                            chemicals
                          </li>
                          <li>
                          ...
                          <li>
                            Religious and cultural activities (flowers, idols,
                            etc.)
                          </li>
                          <li>Solid waste dumping along riverbanks</li>
                          <li>Sand mining and construction activities</li>
                        </ol>
                        <p className="mt-2 text-gray-800">
                          About 70-80% of river pollution in India comes from
                    ...
                    <div className="flex justify-end">
                      <div className="bg-blue-500 text-white rounded-lg rounded-tr-none p-4 max-w-[80%] shadow-sm">
                        <p>
                          How can I organize a river cleanup event in my
                          community?
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-start">
                      <div className="bg-white rounded-lg rounded-tl-none p-4 max-w-[80%] shadow-sm">
                        <p className="text-gray-800">
                          Organizing a river cleanup is a great initiative!
                          Here's a step-by-step guide:
                        </p>
                        <ol className="list-decimal pl-5 mt-2 space-y-1 text-gray-800">
                          <li>
                            <strong>Scout the location</strong> - Identify a
                            safe, accessible site that needs cleaning
                          </li>
                          <li>
                            <strong>Get permits</strong> - Check with local
                            authorities if any permissions are needed
                          </li>
                          <li>
                            <strong>Gather supplies</strong> - Gloves, garbage
                            bags, first aid kits, hand sanitizer
                          </li>
                          <li>
                            <strong>Recruit volunteers</strong> - Use social
                            media, local groups, and schools
                          </li>
                          <li>
                            <strong>Safety briefing</strong> - Educate
                            volunteers about safety precautions
                          </li>
                          <li>
                            <strong>Arrange disposal</strong> - Coordinate with
                            municipal waste management
                          </li>
                        </ol>
                        <p className="mt-2 text-gray-800">
                          You can use our Community page to create and promote
                          your cleanup event!
                        </p>
                      </div>
                    </div>
                ...
                <div className="p-4 border-t border-gray-100">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    This is a simulated chatbot interface. In the actual
                    implementation, this would use AI to provide real-time
                    answers.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
                ...
                <div className="space-y-3">
                  <button className="w-full text-left px-4 py-3 bg-white rounded-md shadow-sm hover:shadow-md transition-shadow flex justify-between items-center">
                    <span className="text-gray-800">
                      What is biochemical oxygen demand (BOD) and why is it
                      important?
                    </span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
